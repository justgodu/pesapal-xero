...
*/
$consumer_key = 'XYl7b/YrsH5YQ5ah0HiDdvp5GqDxIstH';//Register a merchant account on
                   //demo.pesapal.com and use the merchant key for testing.
                   //When you are ready to go live make sure you change the key to the live account
                   //registered on www.pesapal.com!
$consumer_secret = 'TsnCuxX42sqLBw/OWrMMSsYcXjo=';// Use the secret from your test
...
$callback_url = 'https://localhost:8080'; //redirect url, the page that will handle the response from pesapal.
