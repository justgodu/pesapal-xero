<form action="pesapal-iframe.php" method="post">
	<table>
		...
		<tr>
			<td>Reference:</td>
			<td><input type="text" name="reference" value="" />
			(the Order ID )
			</td>
		</tr>
		<tr>
			<td>Shopper's First Name (optional):</td>
			<td><input type="text" name="first_name" value="" /></td>
		</tr>
		<tr>
			<td>Shopper's Last Name (optional):</td>
			<td><input type="text" name="last_name" value="" /></td>
		</tr>
		<tr>
			<td>Shopper's Email Address:</td>
			<td><input type="text" name="email" value="nika.goduadze@yahoo.com" /></td>
		</tr>
		<tr>
